...
import 'package:go_campus/core/windgets/w_button.dart';
...
class _SSignUpState extends State<SSignUp> {
  ...
  void signUp() async {
    if (fromKey.currentState!.validate()) {
      ...
      // debugPrint(email);
      // debugPrint(phone);
      CAuthentication cAuthectication = context.read<CAuthentication>();
      ...
      // set loading state.
      cAuthectication.add(SignUpEvent(mUser));
    } else {
      SvSnackMessage().showSnackMessage(content: "please fill the all fields");
    }
  }

  @override
  Widget build(BuildContext context) {
    final CAuthentication cAuthectication = context.watch<CAuthentication>();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FadeInUp(
                            ...
                            child: cAuthectication.state is LoadingState
                                ? SizedBox(
                                    height: 50,
                                    width: 50,
